...
class Qwen2MLP(nn.Module):
    ...
    def forward(self, x):
        ...
        gate_proj, up_proj = gate_up_proj.split([self.intermediate_size, self.intermediate_size], dim=-1)
...
class Qwen2Attention(nn.Module):
    ...
    def __init__(self, config: Qwen2Config, layer_idx: Optional[int] = None):
        ...
        self.qkv_proj = nn.Linear(self.hidden_size, self.q_size + self.kv_size*2,bias=True)
